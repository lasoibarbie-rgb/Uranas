...
## Initial data import
After deployment, log in as admin and open `/admin/import`. You can import the packaged files or upload updated Excel/Word files. The importer matches clients by normalized names, keeps historical monthly invoices from the payment workbook, and updates contact numbers where a confident match is found.
